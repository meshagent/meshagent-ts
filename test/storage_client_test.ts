...
describe("test storage client", function () {
  ...
  before(async () => {
    jwt = await createJwt("storage_client_test");
  ...
  it("test_storage_create_file", async () => {
    ...
    const handle = await client.storage.open(path, false);
  ...
  it("test_storage_list", async () => {
    ...
    for (const f of files) {
      ...
      const handle = await client.storage.open(fullPath, true);
  ...
  it("test_storage_file_update_events", async () => {
    ...
    const handle2 = await client.storage.open(path, true);
  ...
  it("test_room_client_schema", async () => {
    ...
    const handle = await client.storage.open(path, true);
